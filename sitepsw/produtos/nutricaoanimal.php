...
$nome_categoria = 'nutricaoanimal'; // Pode ser parametrizado para outras marcas
...
<body>
    <header id="cabeçalho">
        <div class="conteudo">
            <div class="caixa-img">
                <img class="logo" src="../imgs/logob.png" alt="logo-agrocampo">
            </div>
            <div class="menu">
...
<?php else : ?>
    <?php foreach ($produtos as $produto) : ?>
        <div class="produto">
            ...
            <p>Categoria: <?php echo htmlspecialchars($produto['tamanho']); ?></p>
            <p>Marca: <?php echo htmlspecialchars($produto['tipo']); ?></p>
