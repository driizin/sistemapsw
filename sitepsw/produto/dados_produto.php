...
<body>
<h1 class="titlo">Informações do Produto:</h1>
<div class="card">
...
// Recebendo as informações do formulário de cadastro de produto
...
echo "Nome do Produto: $nome_produto <br><br>";
echo "Código do Produto: $codigo_produto <br><br>";
echo "Descrição: $descricao <br><br>";
echo "Preço: R$ " . number_format($preco, 2, ',', '.') . "<br><br>";
echo "Quantidade em Estoque: $quantidade <br><br>";
